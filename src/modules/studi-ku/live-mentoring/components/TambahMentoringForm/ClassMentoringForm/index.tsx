...
import { ValidationSchemaClassMentoring } from '@/lib/validation/studi-ku/live-mentoring';
...
export const TambahClassMentoringForm = () => {
  ...
  const form = useForm<z.infer<typeof ValidationSchemaClassMentoring>>({
    resolver: zodResolver(ValidationSchemaClassMentoring),
  });

  const onSubmit = (data: z.infer<typeof ValidationSchemaClassMentoring>) => {
    console.log(data);
  };
