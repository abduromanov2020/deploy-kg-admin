...
import { ValidationSchemaIndividualMentoring } from '@/lib/validation/studi-ku/live-mentoring';
...
export const TambahIndividualMentoringForm = () => {
  const form = useForm<z.infer<typeof ValidationSchemaIndividualMentoring>>({
    resolver: zodResolver(ValidationSchemaIndividualMentoring),
  });

  const onSubmit = (
    data: z.infer<typeof ValidationSchemaIndividualMentoring>,
  ) => {
    console.log(data);
  };
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='grid w-full items-center gap-1.5'>
                ...
                <FormControl>
                  <Input placeholder='Owen Ramadansyah1' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
