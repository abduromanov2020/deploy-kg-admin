...
import { ValidationSchemaGroupMentoring } from '@/lib/validation/studi-ku/live-mentoring';
...
export const TambahGroupMentoringForm = () => {
  const form = useForm<z.infer<typeof ValidationSchemaGroupMentoring>>({
    resolver: zodResolver(ValidationSchemaGroupMentoring),
  });

  const onSubmit = (data: z.infer<typeof ValidationSchemaGroupMentoring>) => {
    console.log(data);
  };
      ...
      >
        <div className='grid grid-cols-2 w-full gap-5 items-start'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='grid w-full items-center gap-1.5'>
                ...
                <FormControl>
                  <Input placeholder='Group 1' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='grid w-full items-center gap-1.5'>
                ...
                <FormControl>
                  <Input placeholder='Erif Michael Ramadansyah' {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='grid w-full items-center gap-1.5'>
                <FormLabel>Tanggal Mentoring</FormLabel>
                <Popover>
        ...
        <FormField
          control={form.control}
          name='mentoring_member'
          render={({ field }) => (
            <FormItem className='grid w-full items-center gap-1.5'>
              <FormLabel>Peserta Mentoring</FormLabel>
              <FormControl>
                <Input
                  placeholder='Mentoring member ...'
                  {...field}
                  onChange={(event) => {
