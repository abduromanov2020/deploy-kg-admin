...
export const ClassMentoringTabItem = () => {
  return (
    <Table className=' border border-gray-400'>
      <TableBody>
        ...
        <TableRow>
          <TableCell className='font-medium align-top border-r'>Sesi</TableCell>
          <TableCell>Sesi 1</TableCell>
        </TableRow>
        ...
        <TableRow>
          ...
          <TableCell>
            Para peserta akan diajak untuk memahami bagaimana sebuah sistem
            pendukung untuk mengatasi tantangan, serta mempercepat pencapaian
            tujuan.
          </TableCell>
        </TableRow>
        <TableRow>
