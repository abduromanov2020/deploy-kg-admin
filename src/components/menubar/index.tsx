...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex py-1 select-none items-center rounded-sm px-3 cursor-pointer text-sm font-medium outline-none focus:bg-slate-100 focus:text-slate-900 data-[state=open]:bg-slate-100 data-[state=open]:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[state=open]:bg-slate-800 dark:data-[state=open]:text-slate-50 hover:shadow-primary-500',
      className,
    )}
    {...props}
  />
...
>(
  (
    { className, align = 'end', alignOffset = -4, sideOffset = 10, ...props },
    ref,
  ) => (
